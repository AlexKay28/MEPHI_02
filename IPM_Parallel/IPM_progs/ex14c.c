...
// Time loop:
  ...
  do {
    ...
    if (np1>1) {
      if (mp_l>=0) {
        i2 = 0;
        for (i1=0; i1<nc1; i1++) { m = nc1 * i2 + i1; ss_l[i1] = yy0[m]; }
      }

      if (mp_r>=0) {
        i2 = nc2m;
        for (i1=0; i1<nc1; i1++) { m = nc1 * i2 + i1; ss_r[i1] = yy0[m]; }
      }
    ...
    for (i1=0; i1<nc1; i1++) {
      j2 = i11 + i1;
      if (j2==0) {
        for (i2=0; i2<nc1; i2++) { m = nc2 * i1 + i2; yy2[m] = g21(tv); }
      }
      else if (j2==n2) {
        for (i2=0; i2<nc1; i2++) { m = nc2 * i1 + i2; yy2[m] = g22(tv); }
      }
      else {
        for (i2=0; i2<nc2; i2++) {
          j1 = i11 + i2;
          ...
          if (j1==0) {
            ...
            aa[i2] = aa1[m]; bb[i2] = bb1[m]; cc[i2] = 1.0 + aa[i2] + bb[i2];
        ...
        for (i2=0; i2<nc2; i2++) { m = nc2 * i1 + i2; yy2[m] = yy0[i2]; }
      }
    }
